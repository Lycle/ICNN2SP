...
from .network import ICNNExpected, ReLUNetworkExpected


def factory_learning_model(args, inst):
    if args.model_type == LearningModelTypes.icnn_e.name:
        from .pytorch_model import ICNNExpectedModel
        return ICNNExpectedModel(
            args.problem,
            inst,
