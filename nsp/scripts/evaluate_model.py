...
def main(args):
    ...
    results = approximator_mip.approximate(
        ...
        presolve=0,
        heuristics=0,   # 0: no heuristics, 1: use heuristics
        nodemethod=1,   # -1=automatic, 0=primal simplex, 1=dual simplex, and 2=barrier
        cuts=1,         # Use value 0 to shut off cuts, 1 for moderate cut generation
        mipfocus=2      # focus more attention on proving optimality, select MIPFocus=2
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type',
                        ...
                        default=LearningModelTypes.nn_e.name,
    ...
    parser.add_argument('--test_set', type=str, default="0",
                        help='Evaluate at the test set (unseen scenarios). Only implemented for CFLP.')
