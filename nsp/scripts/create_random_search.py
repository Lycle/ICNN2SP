...
def get_icnn_e_config():
    """ Defines params space for ICNN-E. """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--problems', type=str, nargs='+', default=["cflp", "sslp", "ip"])
    parser.add_argument('--model_type', type=str, default=["nn_e"])
